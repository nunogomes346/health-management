...
public class CaregiverManager implements Serializable {
    ...
    private final String baseUri = "http://localhost:8080/HealthManagement-web/webapi";
    ...
    public void initClient() {
        ...
        //resteasyWebTarget = (ResteasyWebTarget)client.target(baseUri);
        //resteasyWebTarget.register(new BasicAuthentication(userManager.getUsername(), userManager.getPassword()));
